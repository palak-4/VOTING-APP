    ...
    <div className="w-full bg-white border-t border-b border-gray-200 px-5 py-16 md:py-24 text-gray-800">
        <div className="w-full max-w-6xl mx-auto">
            <div className="text-center max-w-xl mx-auto">
                <h1 className="text-6xl md:text-7xl font-bold mb-5 text-[#2E4057]">What people <br/>are saying.</h1>
                <h3 className="text-xl mb-5 font-light text-black">Discover what our valued users have to say about their experiences with our platform.</h3>
                <div className="text-center mb-10">
                    <span className="inline-block w-1 h-1 rounded-full bg-[#2E4057] ml-1"></span>
                    <span className="inline-block w-3 h-1 rounded-full bg-[#2E4057] ml-1"></span>
                    <span className="inline-block w-40 h-1 rounded-full bg-[#2E4057]"></span>
                    <span className="inline-block w-3 h-1 rounded-full bg-[#2E4057] ml-1"></span>
                    <span className="inline-block w-1 h-1 rounded-full bg-[#2E4057] ml-1"></span>
                </div>
            </div>
